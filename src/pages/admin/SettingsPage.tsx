    ...
    <div className="space-y-4">
      ...
      <div id="identitas" className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100 scroll-mt-24">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="min-w-0">
              <label className="block text-sm font-medium text-gray-600 mb-1">NSM <span className="text-xs text-gray-400">(Madrasah)</span></label>
              <input value={form.nsm} onChange={e => setForm({...form, nsm: e.target.value})} placeholder="Nomor Statistik Madrasah (12 digit)" className="w-full px-4 py-2 border rounded-lg text-sm" />
              <p className="text-xs text-gray-400 mt-1">Khusus RA / MI / MTs / MA — ditampilkan di kop rapor</p>
            </div>
            <div className="min-w-0">
      ...
      <div id="pwa" className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100 scroll-mt-24">
        ...
        <div className="space-y-4">
          ...
          {/* App name */}
          <div>
            <label className="block text-sm font-medium text-gray-600 mb-1">Nama Aplikasi (PWA)</label>
            <input
              value={form.pwa_name}
              onChange={e => setForm({ ...form, pwa_name: e.target.value })}
              placeholder="Contoh: Jurnal Sekolah"
              className="w-full px-4 py-2 border rounded-lg text-sm"
            />
            <p className="text-xs text-gray-400 mt-1">Nama yang tampil saat aplikasi diinstal di perangkat.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <div className="flex gap-2 items-center">
                <input type="color" value={form.pwa_theme_color} onChange={e => setForm({ ...form, pwa_theme_color: e.target.value })} className="w-8 h-8 rounded cursor-pointer shrink-0" />
                <input value={form.pwa_theme_color} onChange={e => setForm({ ...form, pwa_theme_color: e.target.value })} className="flex-1 min-w-0 px-3 py-2 border rounded-lg text-sm font-mono" />
              </div>
              <p className="text-xs text-gray-400 mt-1">Warna bilah status browser/OS saat app dibuka.</p>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-600 mb-1">Background Color</label>
              <div className="flex gap-2 items-center">
                <input type="color" value={form.pwa_bg_color} onChange={e => setForm({ ...form, pwa_bg_color: e.target.value })} className="w-8 h-8 rounded cursor-pointer shrink-0" />
                <input value={form.pwa_bg_color} onChange={e => setForm({ ...form, pwa_bg_color: e.target.value })} className="flex-1 min-w-0 px-3 py-2 border rounded-lg text-sm font-mono" />
              </div>
              <p className="text-xs text-gray-400 mt-1">Warna layar splash saat aplikasi pertama dibuka.</p>
            </div>
          </div>
          ...
          <div>
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 border border-primary/40 bg-primary/5 text-primary rounded-lg text-sm hover:bg-primary/10 transition"
            >
              <Smartphone size={15} />
              Regenerate Manifest
            </button>
          ...
          <div className="rounded-lg bg-blue-50 border border-blue-200 p-4 text-sm text-blue-800">
            ...
            <ul className="list-disc list-inside space-y-1 text-xs text-blue-700">
              ...
              <li>Pastikan PWA diaktifkan dan manifest sudah diregenerasi setelah mengubah pengaturan.</li>
            </ul>
          </div>
        </div>
      </div>
