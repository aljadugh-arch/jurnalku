...
import { Plus, Trash2, X, Heart, MessageCircle, Share2, Flag, MoreVertical, MapPin, Edit2 } from 'lucide-react'
      ...
      <div className="space-y-4">
        ...
        {!posts.length && (
          <div className="flex flex-col items-center py-16 text-gray-400">
            ...
            <button onClick={openCreate} className="mt-3 text-sm text-primary hover:underline">+ Buat posting pertama</button>
          </div>
        )}
      </div>
