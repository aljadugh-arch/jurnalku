...
export default function JamPulangSiswa() {
  ...
  return <section className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100">
    <div className="flex flex-col sm:flex-row sm:justify-between gap-3 mb-4"><div><h2 className="text-lg font-semibold">Jam Pulang Siswa (QR)</h2><p className="text-sm text-gray-500">QR siswa per rombel dan hari khusus RA/TK dan MI/SD. Hari nonaktif menolak scan sebagai hari libur.</p></div><button onClick={save} disabled={saving} className="px-4 py-2 bg-primary text-white rounded-lg text-sm disabled:opacity-50">{saving?'Menyimpan...':'Simpan Jam Pulang'}</button></div>
